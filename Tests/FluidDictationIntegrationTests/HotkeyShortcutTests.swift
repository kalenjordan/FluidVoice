...
final class HotkeyShortcutTests: XCTestCase {
    ...
    func testOutboundDashCommandIsExactAndGlobal() {
        XCTAssertEqual(
            ...
            URL(string: "http://outbound-dash.localhost:8766/")
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            VoiceMacroService.outboundDashURL(transcript: "Commerce Land."),
            URL(string: "http://commerce-land.localhost:8784")
        )
        XCTAssertEqual(
            VoiceMacroService.outboundDashURL(transcript: "Commerceland."),
            URL(string: "http://commerce-land.localhost:8784")
        )
        XCTAssertEqual(
        ...
        let liveSiteCommands = [
            ...
            ("Commerce Land Live.", "https://commerceland.app"),
            ("Commerce Land Live Site.", "https://commerceland.app"),
            ("Commerceland Live.", "https://commerceland.app"),
        ...
        XCTAssertEqual(
            ...
            URL(string: "http://outbound-dash-v2.localhost:8764/clients/signalflame")
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            ...
            URL(string: "http://outbound-dash-v2.localhost:8764/clients/matchbook")
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            ...
            URL(string: "http://outbound-dash.localhost:8766/clients/commerce-leak")
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            ...
            URL(string: "http://outbound-dash-v2.localhost:8764/clients/ordellan")
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            ...
            URL(string: "http://outbound-dash-v2.localhost:8764/clients/st3aero")
        )
        XCTAssertEqual(
        ...
        XCTAssertEqual(
            ...
            URL(string: "http://outbound-dash.localhost:8766/clients/hvac")
        )
        XCTAssertEqual(
            VoiceMacroService.outboundDashURL(transcript: "Layers Dash."),
            URL(string: "http://outbound-dash.localhost:8766/clients/layers")
        )
        XCTAssertEqual(
            VoiceMacroService.outboundDashURL(transcript: "Insured Near Dash."),
            URL(string: "http://outbound-dash.localhost:8766/clients/insured-near")
        )
        XCTAssertEqual(
            VoiceMacroService.outboundDashURL(transcript: "Outbound Farm Dash."),
            URL(string: "http://outbound-dash.localhost:8766/clients/outbound-farm")
        )
        XCTAssertEqual(
            VoiceMacroService.outboundDashURL(transcript: "Outbound Farm Next Dash."),
            URL(string: "http://outbound-dash-v2.localhost:8764/clients/outbound-farm-next")
        )
        XCTAssertEqual(
            VoiceMacroService.outboundDashURL(transcript: "Yedrick Dash."),
            URL(string: "http://outbound-dash.localhost:8766/clients/yedric")
        )
        XCTAssertEqual(
    ...
    func testChromeURLCommandResolvesClientDashboardAndIsAppScoped() {
        ...
        XCTAssertEqual(
            ...
            "http://outbound-dash-v2.localhost:8764/clients/ordellan"
        )
        XCTAssertEqual(
            VoiceMacroService.chromeURL(
            ...
            "http://outbound-dash.localhost:8766/clients/hvac"
        )
        XCTAssertEqual(
            VoiceMacroService.chromeURL(
